          ...
          switch (message.type) {
            case "text": {
              ...
              await WhatsappMessager.sendFreeFormTextMessage(
                textMsg.from,
                "Hello, thank you for contacting us. Please contact our agents on this number 0781590257"
              );
              ...
              const client = clients.find(
                (client) =>
                  client.firstName == "Nothando" && client.lastName == "Masiya"
              );
              if (client) {
                await WhatsappMessager.sendTemplateMessage(
